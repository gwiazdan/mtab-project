    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <nav className="sticky top-0 z-40 flex justify-between bg-background border-b border-gray-800 h-16 px-4 pr-0 md:pr-4">
        ...
        <div className='items-center gap-4 flex pr-4'>
          {/* Shop Icon */}
          <Link to="/" className="flex items-center justify-center w-8 h-8 hover:bg-gray-800 rounded-lg transition-colors">
          ...
          {isAdmin && (
            <button
              ...
              className="px-3 py-1 text-sm font-medium bg-red-600 hover:bg-red-700 rounded-lg transition-colors text-white"
            >
              Logout
            </button>
          )}
